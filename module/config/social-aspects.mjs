...
export const SOCIAL_MANUAL_LAYOUTS = Object.freeze({
  status: [["society", 8], ["points", 2], ["level", 2], ["status_name", 5], ["monthly_cost", 7], ["description", 12]],
  organization: [["organization_name", 8], ["points", 2], ["level", 2], ["status_name", 5], ["salary", 7], ["description", 12]],
  culture: [["culture_name", 8], ["points", 2], ["level", 2], ["description", 12]],
  language: [["language_name", 10], ["points", 2], ["spoken_level", 6], ["written_level", 6], ["description", 12]],
  wealth: [["wealth_level", 10], ["points", 2], ["effects", 12]],
