...
export function appendResistanceRequestResult(content, { result, consequenceLabel, purposeLabels = [], userName = "" }) {
  ...
  updated = updated.replace(/(<strong class="request-result)[^"]*(">)Pendente(<\/strong>)/i, "$1 request-result-resolved$2Resolvido$3");
